...
public class Absence {
    ...
    //methode pour imprimer une liste d'absence dans un fichier.txt
    public void imprimer(String nomFichier){
        try (PrintWriter writer = new PrintWriter(new FileWriter(nomFichier))) {
            for (Eleve e : this.classe.eleves) {
                writer.println(e);  // utilise Eleve.toString()
            }
